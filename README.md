# eslint-config-ctdesarrollo

This package provides CTDesarrollo's `.eslintrc` as an extensible shared config.
...
2. Add `"extends": "ctdesarrollo"` to your `.eslintrc`
...
2. Add `"extends": "ctdesarrollo/back"` to your `.eslintrc`

### eslint-config-ctdesarrollo/front
...
2. Add `"extends": "ctdesarrollo/front"` to your `.eslintrc`

### eslint-config-ctdesarrollo/typescript
...
2. Add `"extends": "ctdesarrollo/typescript"` to your `.eslintrc`
